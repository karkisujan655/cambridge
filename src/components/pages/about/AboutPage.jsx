      ...
      <div className="intro-box">
        <div className="intro">
          ...
          <p className="intro-desc">
            ...
            numquam aspernatur porro cum veritatis cupiditate. Eligendi modi
            voluptatum temporibus quam, dolore natus aliquam alias assumenda,
            quas maiores soluta cum blanditiis accusamus, amet illo deleniti
        ...
        <div className="mv-box">
          <div className="mission">
            ...
            <p className="mission-desc">
              ...
              universities, leveraging our extensive network to facilitate this
              educational connection and bridge the gap between advanced
          ...
          <div className="vision">
            ...
            <p className="vision-desc">
              ...
              process with confidence, knowing they have reliable assistance at
              every step. Lastly, our language ability test coaching equips
